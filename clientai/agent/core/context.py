...
class AgentContext:
    ...
    This class serves as a central repository for maintaining agent state across workflow 
    executions. It stores step results, tracks conversation history, maintains iteration 
    counts, and stores arbitrary state data needed during workflow execution.
    ...
    Attributes:
        ...
        original_input: The original input stored separately from current_input.
    ...
    def set_input(self, input_data: Any) -> None:
        ...
        Example:
            ...
            context.set_input("What is Python?")
            context.set_step_result("analyze", "Python is a programming language")
            context.set_input("How do I install Python?")  # Previous interaction saved
            ```
        """
